...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    this.httpClient.put('https://recipes-23805-default-rtdb.firebaseio.com/recipes.json', recipes).subscribe(response => {
      console.log(response);
    });
  }

  fetchRecipes() {
    return this.httpClient.get<Recipe[]>('https://recipes-23805-default-rtdb.firebaseio.com/recipes.json')
